...
<style>
footer {
	background-image: url('https://images.pexels.com/photos/8477358/pexels-photo-8477358.jpeg?auto=compress&cs=tinysrgb&w=600');
...
<footer class="text-center text-lg-start bg-body-tertiary text-muted">
	...
	<section class="d-flex justify-content-center justify-content-lg-between p-3 border-bottom">
		<div class="me-3 d-none d-lg-block" style="color:white;font-weight:600;">
	...
	<section class="container text-md-start mt-3" style="background-color: transparent;">
		<div class="footer-section row" style="background-color: transparent;">
			<!-- Column 1 -->
			<div class="col-md-3 col-lg-4 col-xl-3 mb-4" style="color:white;">
